...
就在上周我编写ATL代码的时候还在把BSTR和OLECHAR类型 还有什么CHAR* LPSTR之类的搞来搞去 ， 这些现在全都滚蛋了。
